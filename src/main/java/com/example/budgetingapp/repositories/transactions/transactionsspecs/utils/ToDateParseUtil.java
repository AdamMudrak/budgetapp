...
public class ToDateParseUtil {
    ...
    private static final int BASIC_MONTH = 12;
        ...
        try {
            switch (dateString.length()) {
                case DEFAULT_YEAR_MONTH_DAY_LENGTH -> {
                    ...
                    return LocalDate.of(now.getYear(), now.getMonth(), now.lengthOfMonth());
                }
                ...
                case YEAR_AND_MONTH_STRING_LENGTH -> {
                    LocalDate withoutLastDay = LocalDate.of(Integer.parseInt(dateString
                                    .substring(YEAR_INDICES[0], YEAR_INDICES[1])),
                            Integer.parseInt(dateString.substring(MONTH_INDICES[0])), BASIC_DAY);
                    return LocalDate.of(
                            withoutLastDay.getYear(),
                            withoutLastDay.getMonth(),
                            withoutLastDay.lengthOfMonth());
                }
