...
public class TransactionDtoConstants {
    public static final String NAME = "name";
    public static final String NAME_EXAMPLE = "new target";

    public static final String COMMENT = "comment";
    public static final String COMMENT_EXAMPLE = "new transaction";

    public static final String AMOUNT = "amount";
    public static final String AMOUNT_EXAMPLE = "999.99";
    public static final String SUM_OF_REPLENISHMENT = "sumOfReplenishment";
    public static final String SUM_OF_REPLENISHMENT_EXAMPLE = "999.99";
    ...
    public static final String TO_ACCOUNT_ID_EXAMPLE = "1";

    public static final String DATE = "transactionDate";
    public static final String DATE_EXAMPLE = "2024-10-29";
